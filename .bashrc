function git_branch_name()
{
    ...
    then
        ...
        state=$(git status | grep "nothing to commit, working tree clean" | wc -l)
        if [ $state -eq 0 ];
        then
            echo -e 'on (\e[38;5;196m'$branch'\e[91m) '
        else
            echo -e 'on (\e[38;5;32m'$branch'\e[91m) '
        fi
    fi
}
...
# export PS1="\[\e[94m\\]\u \[\e[00m\\]in \[\e[32m\]\W \[\e[91m\]\$(git_branch_name)\[\e[00m\]\[\e[33m\\] λ \[\e[00m\]"
export PS1="\[\e[33m\\] λ \[\e[00m\]\[\e[1m\]\[\e[94m\]\W \[\e[0m\]\[\e[91m\]\$(git_branch_name)\[\e[00m\]"
